 ...
 * @author jitzu
 */
public class usernamePopup extends javax.swing.JDialog {

    /**
     * Creates new form loginPopup
     */
    private mainView mainViews;
    public usernamePopup(java.awt.Frame parent, boolean modal, mainView mainViews) {
        super(parent, modal);
    ...
    private void btnLoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLoginActionPerformed
        ...
        loginPopup loginPopups = new loginPopup(null, true, this.mainViews, txtUsername.getText());
